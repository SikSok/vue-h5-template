...
<template>
  <div>
    <van-cell title="姓名" :value="item.DisplayName | complete" />
    ...
    <van-cell title="生日" :value="item.Birthday | complete" />
    <van-cell title="入职日期" :value="item.JoinedDate | complete" />
    <van-cell title="工作地点" :value="item.WorkPlaceId | complete" />
